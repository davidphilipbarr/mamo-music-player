...
```bash
sudo dnf install python3 python3-gobject gtk4 libadwaita python3-mutagen gstreamer1-plugins-base gstreamer1-plugins-good gstreamer1-plugins-bad-free gstreamer1-plugins-ugly-free gstreamer1-libav
```
